        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 style="margin-left:40%; font-size:30px;" class="card-title">Relatório de Contatos</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    ?>
                  <tr>
                    <td style="text-align:center;"><img style="width:55px;border-radius:1100%;" src="img/contato/<?php echo $show->foto_contato;?>"></td>
